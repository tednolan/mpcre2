...
;
	...
	if mstr'="ox" write "pcre2substringcopybyname unexpected substring (",mstr,")",! quit
	...
	if mstr2'="ck Brown " write "pcre2substringgetbynumber unexpected substring (",mstr2,")",! quit
